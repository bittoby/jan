...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      MODEL_CATALOG_CDN_URL: JSON.stringify(
        'https://apps.jan.ai/raw.githubusercontent.com/janhq/model-catalog/main/model_catalog_v2.json'
      ),
      LATEST_JAN_MODEL_URL: JSON.stringify(
        'https://raw.githubusercontent.com/janhq/model-catalog/main/latest_jan_model.json'
      ),
      LATEST_JAN_MODEL_CDN_URL: JSON.stringify(
        'https://apps.jan.ai/raw.githubusercontent.com/janhq/model-catalog/main/latest_jan_model.json'
      ),
